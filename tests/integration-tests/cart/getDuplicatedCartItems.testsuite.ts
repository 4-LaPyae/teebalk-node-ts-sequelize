...
import { ErrorTypeEnum, LanguageEnum, PurchaseItemErrorMessageEnum } from '../../../src/constants';

const request = require('supertest');

const app = require('../index');

export const testGetDuplicatedCartItemsList = () =>
  describe('CART: Get duplicated cart items list', () => {
    ...
    beforeAll(async () => {
      ...
      productColor = await ProductColorDbModel.bulkCreate(productColorData);
      ...
      await CartDbModel.bulkCreate(cartData);
      userToken =
    ...
    it('should return DUPLICATED_PARAMETER error', async () => {
      await ProductColorDbModel.update(
        {
          deletedAt: new Date()
        },
        {
