...
describe('Unitest:Service:Cart:UpdateCartById', () => {
  describe('Cart:UpdateCartById', () => {
    ...
    describe('UpdateCartById:Check updated result', () => {
      it('should equal to the mock data', async () => {
        const result = await cartService.updateById(mockData.userId, 1, mockCart);
