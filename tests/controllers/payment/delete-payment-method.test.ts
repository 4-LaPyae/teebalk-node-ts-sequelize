...
const mockCombinedUserData = {
  ...
  createdAt: '2021-03-24T03:55:40.902Z',
  updatedAt: '2021-03-24T03:55:40.902Z',
  accessToken: 'eyXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX.eyXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX.mfXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
};
...
jest.mock('../../../src/services', () => {
  ...
  const stripeService = {
    ...
    detachPaymentMethod: jest.fn(() =>  Promise.resolve())
  };
...
describe('Controller:Payment:deletePaymentMethod', () => {
  ...
  it('should return ERROR message', async () => {
    try {
      await paymentController.deletePaymentMethod({ id: 1 } as IUser, '');
    } catch (error) {
      expect(error.message).toMatch('Parameter "paymentMethodId" is invalid');
    }
  });
  ...
  it('should return error 403', async () => {
    try {
      ...
      await paymentController.deletePaymentMethod(user, 'pm_abcdef');
    } catch (error) {
      expect(error.message).toMatch('You do not have permission to delete this payment method');
    }
  });
  ...
  it('should return true', async () => {
    ...
    const result = await paymentController.deletePaymentMethod(user, 'pm_1L8iWGF5vyRDfvMCw1JoUzV8');
