...
describe('Controller:Product:GetUnpublishedList', () => {
  describe('Product:GetUnpublishedList', () => {
    ...
    describe('GetUnpublishedList: Check total number of UNPUBLISHED product', () => {
      it('should return 15', async () => {
        const result = await productController.getUnpublishedOnlineProductList(1, pagination);
        expect(result.count).toBe(15);
      });
    });

    describe('GetUnpublishedList: Check length result', () => {
    ...
    describe('GetUnpublishedList: Error missing userId', () => {
      it('should return ERROR message', async () => {
        try {
          await productController.getUnpublishedOnlineProductList(0, pagination);
        } catch (error) {
